...
CREATE TABLE IF NOT EXISTS aut_audit_logs
(
    id                BIGINT       NOT NULL,
...
CREATE TABLE IF NOT EXISTS bil_plans
(
...
CREATE TABLE IF NOT EXISTS bil_subscriptions
(
...
CREATE TABLE IF NOT EXISTS bil_usage_counters
(
    organization_id BIGINT      NOT NULL,
...
CREATE TABLE IF NOT EXISTS cnt_contact_tags
(
...
CREATE TABLE IF NOT EXISTS msg_campaign_cc_tags
(
    cnt_tag_id      BIGINT NOT NULL,
    msg_campaign_id BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS msg_campaign_cci_tags
(
    cnt_tag_id      BIGINT NOT NULL,
    msg_campaign_id BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS msg_campaign_contact_results
(
    id            BIGINT      NOT NULL,
    created_at    TIMESTAMP WITHOUT TIME ZONE,
    updated_at    TIMESTAMP WITHOUT TIME ZONE,
...
CREATE TABLE IF NOT EXISTS msg_campaigns_contacts
(
    campaign_id BIGINT NOT NULL,
    contacts_id BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS msg_campaigns_tags
(
    contacts_id BIGINT NOT NULL,
    tags_id     BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS msg_email_cc_contacts
(
    cnt_contact_id  BIGINT NOT NULL,
    msg_campaign_id BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS msg_email_cci_contacts
(
    cnt_contact_id  BIGINT NOT NULL,
    msg_campaign_id BIGINT NOT NULL
);

CREATE TABLE IF NOT EXISTS msg_event_registration_workflow_steps
(
    id               BIGINT      NOT NULL,
    created_at       TIMESTAMP WITHOUT TIME ZONE,
    updated_at       TIMESTAMP WITHOUT TIME ZONE,
...
CREATE TABLE IF NOT EXISTS msg_message_events
(
    msg_event_id   BIGINT NOT NULL,
    msg_message_id BIGINT NOT NULL
);
...
CREATE TABLE IF NOT EXISTS prs_phone_number
(
    id                BIGINT NOT NULL,
    created_at        TIMESTAMP WITHOUT TIME ZONE,
    updated_at        TIMESTAMP WITHOUT TIME ZONE,
...
CREATE TABLE IF NOT EXISTS prs_user_roles
(
    aut_role_id BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS prs_users_logs
(
    user_id BIGINT NOT NULL,
